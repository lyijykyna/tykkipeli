...
//    }
	...
	Lentorata rata = new Lentorata(this.peliMaailma,alkupsijainti.x, alkupsijainti.y, pelaaja.getTeho()*Math.cos(pelaaja.getKoroRadiaaneina()), pelaaja.getTeho()*Math.sin(pelaaja.getKoroRadiaaneina()), 0);
